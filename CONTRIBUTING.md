...
There are several ways you can contribute to the genesis:
...
1. **Fork the Repository**: Fork the genesis repository to your GitHub account.
...
By contributing to the genesis, you agree that your contributions will be licensed under the [MIT](https://github.com/ambiere/genesis/blob/main/LICENSE) license.
